...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    navMenu: Attribute.Component<'layout.nav-menu'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    available: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    contactLink: Attribute.Component<'components.link'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    phone: Attribute.Component<'components.link'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
  ...
  attributes: {
    blocks: Attribute.DynamicZone<
      [
        'layout.hero-section',
        'layout.services-section',
        'layout.selected-work-section',
        'layout.process-section',
        'layout.works-section',
        'layout.working-with-me',
        'layout.about-me'
      ]
    > &
...
export interface ApiPricingPagePricingPage extends Schema.SingleType {
  ...
  attributes: {
    priceBlocks: Attribute.Component<'layout.price-block', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    FAQ: Attribute.Component<'layout.faq'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
